...
Doorkeeper::OpenidConnect.configure do
  ...
  claims do
    ...
    claim :email, response: %i[user_info id_token], scope: :openid do |resource_owner| # rubocop:disable Style/SymbolProc
    ...
    # This is kept as a block instead of a callable proc in case it is desired, later, to
    # increase privacy via the confidential parameter
    claim :username, response: %i[user_info id_token], scope: :openid do |resource_owner| # rubocop:disable Style/SymbolProc
